...
const MarketingPage = () => {
  ...
  const columns = [
    ...
    return (
      ...
      <li className={`w-full py-2 pl-4 text-[14px] ${delever=='banner'?'bg-[#4094F7] text-white':'bg-white text-[#252C32]'} leading-6 font-medium cursor-pointer  rounded-[6px]`}>Баннеры</li>
